        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 text-lg">
              ...
              <a href="mailto:frankgrasso@westchsterselect.com" className="bg-gold hover:bg-gold/90 text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                <span>✉️</span>
                <span>Email Me</span>
              </a>
            </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-charcoal via-charcoal to-gray-800 text-charcoal">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="mailto:frankgrasso@westchsterselect.com"
